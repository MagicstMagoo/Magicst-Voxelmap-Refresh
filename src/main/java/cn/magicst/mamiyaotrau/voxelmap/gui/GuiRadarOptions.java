 ...
 public class GuiRadarOptions extends GuiScreenMinimap {
   ...
   public void method_25426() {
     ...
     method_25396().clear();
     int var2 = 0;
     this.screenTitle = (class_2561)new class_2588("options.minimap.radar.title");
     ...
     if (this.options.radarMode == 2) {
       method_37063((class_364)new class_4185(getWidth() / 2 - 155, getHeight() / 6 + 144 - 6, 150, 20, (class_2561)new class_2588("options.minimap.radar.selectmobs"), buttonx -> getMinecraft().method_1507((class_437)new GuiMobs((class_437)this, this.options))));
     }
     
     method_37063((class_364)new class_4185(getWidth() / 2 - 100, getHeight() / 6 + 168, 200, 20, (class_2561)new class_2588("gui.done"), buttonx -> getMinecraft().method_1507(this.parent)));
   }
   ...
   protected void optionClicked(class_4185 buttonClicked) {
     ...
     if (((GuiOptionButtonMinimap)buttonClicked).returnEnumOptions().equals(EnumOptionsMinimap.RADARMODE)) {
       ...
       buttonClicked.method_25355((class_2561)new class_2585(this.options.getKeyText(option)));
