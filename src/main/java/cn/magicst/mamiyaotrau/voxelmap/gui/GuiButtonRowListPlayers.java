 ...
 public class GuiButtonRowListPlayers extends class_350 {
   ...
   Row everyoneRow;
   final class_2588 ALL = new class_2588("minimap.waypointshare.all");
   final class_2588 TITLE = new class_2588("minimap.waypointshare.sharewitheveryone");
   final class_2588 EXPLANATION = new class_2588("minimap.waypointshare.sharewitheveryone2");
   final class_2588 AFFIRM = new class_2588("gui.yes");
   final class_2588 DENY = new class_2588("gui.cancel");
   ...
   public GuiButtonRowListPlayers(GuiSelectPlayer par1GuiSelectPlayer) {
     ...
     sort();
     class_4185 everyoneButton = new class_4185(this.parentGui.getWidth() / 2 - 75, 0, 150, 20, (class_2561)this.ALL, null)
       {
   ...
   private class_2561 getPlayerName(class_640 ScoreboardEntryIn) {
     return (ScoreboardEntryIn.method_2971() != null) ? ScoreboardEntryIn.method_2971() : (class_2561)new class_2585(ScoreboardEntryIn.method_2966().getName());
   }
   ...
   public void buttonClicked(int id) {
     if (id == -1) {
       ...
       class_410 confirmScreen = new class_410(this.parentGui, (class_2561)this.TITLE, (class_2561)this.EXPLANATION, (class_2561)this.AFFIRM, (class_2561)this.DENY);
   ...
   public class Row
     extends class_350.class_351<Row>
   {
     private final class_310 client = class_310.method_1551();
