 ...
 public class GuiSubworldEdit extends GuiScreenMinimap implements BooleanConsumer {
   ...
   public void method_25426() {
     ...
     method_37063((class_364)(this.doneButton = new class_4185(getWidth() / 2 - 155, getHeight() / 6 + 168, 150, 20, (class_2561)new class_2588("gui.done"), button -> changeNameClicked())));
     method_37063((class_364)new class_4185(getWidth() / 2 + 5, getHeight() / 6 + 168, 150, 20, (class_2561)new class_2588("gui.cancel"), button -> getMinecraft().method_1507(this.parent)));
     int buttonListY = getHeight() / 6 + 82 + 6;
     method_37063((class_364)(this.deleteButton = new class_4185(getWidth() / 2 - 50, buttonListY + 24, 100, 20, (class_2561)new class_2588("selectServer.delete"), button -> deleteClicked())));
   ...
   private void deleteClicked() {
     ...
     class_2588 title = new class_2588("worldmap.subworld.deleteconfirm");
