   ...
   extends GuiScreenMinimap
 {
   ...
   private class_2561 tooltip = null; private GuiSlotMobs mobsList; private class_4185 buttonEnable; private class_4185 buttonDisable; protected class_342 filter;
   ...
   public void method_25426() {
     this.screenTitle = (class_2561)new class_2588("options.minimap.mobs.title");
     ...
     method_37063((class_364)(this.buttonEnable = new class_4185(getWidth() / 2 - 154, getHeight() - 28, 100, 20, (class_2561)new class_2588("options.minimap.mobs.enable"), button -> setMobEnabled(this.selectedMobId, true))));
     method_37063((class_364)(this.buttonDisable = new class_4185(getWidth() / 2 - 50, getHeight() - 28, 100, 20, (class_2561)new class_2588("options.minimap.mobs.disable"), button -> setMobEnabled(this.selectedMobId, false))));
     method_37063((class_364)new class_4185(getWidth() / 2 + 4 + 50, getHeight() - 28, 100, 20, (class_2561)new class_2588("gui.done"), button -> getMinecraft().method_1507(this.parentScreen)));
