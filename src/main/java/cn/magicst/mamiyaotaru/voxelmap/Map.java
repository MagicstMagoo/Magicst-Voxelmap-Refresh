...
import cn.mojang.blaze3d.systems.RenderSystem;
...
public void forceFullRender(boolean forceFullRender) {
  ...
  private void cycleZoomLevel() {
     if (this.options.zoom == 4) {
       ...
       if (this.multicore && class_316.field_1933.method_18613(this.game.field_1690) > 8.0D) {
         this.options.zoom = 4;
         this.error = I18nUtils.getString("minimap.ui.zoomlevel", new Object[0]) + " (0.25x)";
      } else {
         this.options.zoom = 3;
  ...
  private int getSkyColor() {
     ...
     class_758.method_3210(this.game.field_1773.method_19418(), 0.0F, this.world, this.game.field_1690.field_1870, this.game.field_1773.method_3195(0.0F));
  ...
  public void drawMinimap(class_4587 matrixStack, class_310 mc) {
     ...
     this.game.field_1772.method_30881(modelViewMatrixStack, (class_2561)new class_2585("******sdkfjhsdkjfhsdkjfh"), 100.0F, 100.0F, -1);
...
private void drawWelcomeScreen(class_4587 matrixStack, int scWidth, int scHeight) {
  if (this.welcomeText[1] == null || this.welcomeText[1].getString().equals("minimap.ui.welcome2")) {
    this.welcomeText[0] = (class_2561)(new class_2585("")).method_10852((class_2561)(new class_2585("VoxelMap! ")).method_27692(class_124.field_1061)).method_27693(this.zmodver + " ").method_10852((class_2561)new class_2588("minimap.ui.welcome1"));
    this.welcomeText[1] = (class_2561)new class_2588("minimap.ui.welcome2");
    this.welcomeText[2] = (class_2561)new class_2588("minimap.ui.welcome3");
    this.welcomeText[3] = (class_2561)new class_2588("minimap.ui.welcome4");
    this.welcomeText[4] = (class_2561)(new class_2585("")).method_10852((class_2561)(new class_2572(this.options.keyBindZoom.method_1431())).method_27692(class_124.field_1075)).method_27693(": ").method_10852((class_2561)new class_2588("minimap.ui.welcome5a")).method_27693(", ").method_10852((class_2561)(new class_2572(this.options.keyBindMenu.method_1431())).method_27692(class_124.field_1075)).method_27693(": ").method_10852((class_2561)new class_2588("minimap.ui.welcome5b"));
    this.welcomeText[5] = (class_2561)(new class_2585("")).method_10852((class_2561)(new class_2572(this.options.keyBindFullscreen.method_1431())).method_27692(class_124.field_1075)).method_27693(": ").method_10852((class_2561)new class_2588("minimap.ui.welcome6"));
    this.welcomeText[6] = (class_2561)(new class_2585("")).method_10852((class_2561)(new class_2572(this.options.keyBindWaypoint.method_1431())).method_27692(class_124.field_1075)).method_27693(": ").method_10852((class_2561)new class_2588("minimap.ui.welcome7"));
    this.welcomeText[7] = (class_2561)this.options.keyBindZoom.method_16007().method_27661().method_27693(": ").method_10852((class_2561)(new class_2588("minimap.ui.welcome8")).method_27692(class_124.field_1080));
    } 
