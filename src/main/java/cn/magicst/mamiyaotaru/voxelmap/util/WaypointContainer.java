 ...
 public class WaypointContainer
 {
   ...
   private void renderLabel(class_4587 matrixStack, Waypoint pt, double distance, boolean isPointedAt, String name, double baseX, double baseY, double baseZ, int par9, boolean withDepth, boolean withoutDepth) {
     ...
     name = name + " (" + name + "m)";
     double maxDistance = ((Integer)(GameVariableAccessShim.getMinecraft()).field_1690.method_42510().method_41753()).intValue() * 16.0D * 0.99D;
     ...
     if (isPointedAt && fontRenderer != null) {
       ...
       if (withoutDepth) {
         ...
         GLShim.glDisable(2929);
         fontRenderer.method_30882((class_2561)class_2561.method_43470(name), (-fontRenderer.method_1727(name) / 2), elevateBy, textColor, false, matrix4f, (class_4597)vertexConsumerProvider, true, 0, 15728880);
