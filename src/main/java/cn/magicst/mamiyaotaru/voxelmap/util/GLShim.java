 ...
 public class GLShim
 {
   ...
   public static void glEnable(int attrib) {
     switch (attrib) { case 2884:
         RenderSystem.enableCull(); break;
       case 2929: RenderSystem.enableDepthTest(); break;
       case 3042: RenderSystem.enableBlend(); break;
       case 3089: GL11.glEnable(3089); break;
       case 3553: RenderSystem.enableTexture(); break;
   ...
   public static void glDisable(int attrib) {
     switch (attrib) { case 2884:
       ...
       case 2929: RenderSystem.disableDepthTest(); break;
       case 3042: RenderSystem.disableBlend(); break;
       case 3089: GL11.glDisable(3089); break;
       case 3553: RenderSystem.disableTexture(); break;
