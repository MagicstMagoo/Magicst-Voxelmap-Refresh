   ...
   implements BooleanConsumer
 {
   ...
   public void method_25426() {
     ...
     if (!this.multiworld && !this.waypointManager.isMultiworld() && !getMinecraft().method_1589()) {
       class_410 confirmScreen = new class_410(this, (class_2561)class_2561.method_43471("worldmap.multiworld.isthismultiworld"), (class_2561)class_2561.method_43471("worldmap.multiworld.explanation"), (class_2561)class_2561.method_43471("gui.yes"), (class_2561)class_2561.method_43471("gui.no"));
     ...
     this.title = (class_2561)class_2561.method_43471("worldmap.multiworld.title");
     this.select = (class_2561)class_2561.method_43471("worldmap.multiworld.select");
     method_37067();
     ...
     class_4185 cancelBtn = new class_4185(centerX - 100, this.field_22790 - 30, 200, 20, (class_2561)class_2561.method_43471("gui.cancel"), button -> getMinecraft().method_1507(null));
     ...
     for (int t = 0; t < numKnownSubworlds; t++) {
       ...
       int tt = t;
       selectButtons[t] = new class_4185((buttonsPerRow - shiftBy - t % buttonsPerRow) * buttonWidth + xSpacing, this.field_22790 - 60 - t / buttonsPerRow * 21, buttonWidth - 32, 20, (class_2561)class_2561.method_43470(this.worlds[t]), button -> worldSelected(this.worlds[tt]));
       editButtons[t] = new class_4185((buttonsPerRow - shiftBy - t % buttonsPerRow) * buttonWidth + xSpacing + buttonWidth - 32, this.field_22790 - 60 - t / buttonsPerRow * 21, 30, 20, (class_2561)class_2561.method_43470("⚒"), button -> editWorld(this.worlds[tt]));
     ...
     if (!this.newWorld) {
       selectButtons[numButtons] = new class_4185((buttonsPerRow - 1 - lastRowShiftBy - numButtons % buttonsPerRow) * buttonWidth + xSpacing, this.field_22790 - 60 - numButtons / buttonsPerRow * 21, buttonWidth - 2, 20, (class_2561)class_2561.method_43470("< " + I18nUtils.getString("worldmap.multiworld.newname", new Object[0]) + " >"), button -> {
             this.newWorld = true;
