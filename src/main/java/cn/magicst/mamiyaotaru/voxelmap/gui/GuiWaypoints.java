   ...
   implements IGuiWaypoints
 {
   ...
   private class_2561 tooltip = null; private boolean deleteClicked = false; private class_4185 buttonHighlight; private class_4185 buttonShare; private class_4185 buttonTeleport; private class_4185 buttonSortName; private class_4185 buttonSortCreated; private class_4185 buttonSortDistance; private class_4185 buttonSortColor; protected class_342 filter; private boolean addClicked = false;
   ...
   public void method_25426() {
     this.screenTitle = (class_2561)new class_2588("minimap.waypoints.title");
     (getMinecraft()).field_1774.method_1462(true);
     this.waypointList = new GuiSlotWaypoints(this);
     method_37063((class_364)(this.buttonSortName = new class_4185(getWidth() / 2 - 154, 34, 77, 20, (class_2561)new class_2588("minimap.waypoints.sortbyname"), button -> sortClicked(2))));
     method_37063((class_364)(this.buttonSortDistance = new class_4185(getWidth() / 2 - 77, 34, 77, 20, (class_2561)new class_2588("minimap.waypoints.sortbydistance"), button -> sortClicked(3))));
     method_37063((class_364)(this.buttonSortCreated = new class_4185(getWidth() / 2, 34, 77, 20, (class_2561)new class_2588("minimap.waypoints.sortbycreated"), button -> sortClicked(1))));
     method_37063((class_364)(this.buttonSortColor = new class_4185(getWidth() / 2 + 77, 34, 77, 20, (class_2561)new class_2588("minimap.waypoints.sortbycolor"), button -> sortClicked(4))));
     ...
     method_37063((class_364)(this.buttonEdit = new class_4185(getWidth() / 2 - 154, getHeight() - 52, 74, 20, (class_2561)new class_2588("selectServer.edit"), button -> editWaypoint(this.selectedWaypoint))));
     method_37063((class_364)(this.buttonDelete = new class_4185(getWidth() / 2 - 76, getHeight() - 52, 74, 20, (class_2561)new class_2588("selectServer.delete"), button -> deleteClicked())));
     method_37063((class_364)(this.buttonHighlight = new class_4185(getWidth() / 2 + 2, getHeight() - 52, 74, 20, (class_2561)new class_2588("minimap.waypoints.highlight"), button -> setHighlightedWaypoint())));
     method_37063((class_364)(this.buttonTeleport = new class_4185(getWidth() / 2 + 80, getHeight() - 52, 74, 20, (class_2561)new class_2588("minimap.waypoints.teleportto"), button -> teleportClicked())));
     method_37063((class_364)(this.buttonShare = new class_4185(getWidth() / 2 - 154, getHeight() - 28, 74, 20, (class_2561)new class_2588("minimap.waypoints.share"), button -> CommandUtils.sendWaypoint(this.selectedWaypoint))));
     method_37063((class_364)new class_4185(getWidth() / 2 - 76, getHeight() - 28, 74, 20, (class_2561)new class_2588("minimap.waypoints.newwaypoint"), button -> addWaypoint()));
     method_37063((class_364)new class_4185(getWidth() / 2 + 2, getHeight() - 28, 74, 20, (class_2561)new class_2588("menu.options"), button -> getMinecraft().method_1507((class_437)new GuiWaypointsOptions((class_437)this, this.options))));
     method_37063((class_364)new class_4185(getWidth() / 2 + 80, getHeight() - 28, 74, 20, (class_2561)new class_2588("gui.done"), button -> getMinecraft().method_1507(this.parentScreen)));
   ...
   private void sort() {
     ...
     if (sortKey == 2) {
       this.buttonSortName.method_25355((class_2561)new class_2585(arrow + " " + arrow + " " + I18nUtils.getString("minimap.waypoints.sortbyname", new Object[0])));
     } else {
       this.buttonSortName.method_25355((class_2561)new class_2588("minimap.waypoints.sortbyname"));
     } 
     
     if (sortKey == 3) {
       this.buttonSortDistance.method_25355((class_2561)new class_2585(arrow + " " + arrow + " " + I18nUtils.getString("minimap.waypoints.sortbydistance", new Object[0])));
     } else {
       this.buttonSortDistance.method_25355((class_2561)new class_2588("minimap.waypoints.sortbydistance"));
     } 
     
     if (sortKey == 1) {
       this.buttonSortCreated.method_25355((class_2561)new class_2585(arrow + " " + arrow + " " + I18nUtils.getString("minimap.waypoints.sortbycreated", new Object[0])));
     } else {
       this.buttonSortCreated.method_25355((class_2561)new class_2588("minimap.waypoints.sortbycreated"));
     } 
     
     if (sortKey == 4) {
       this.buttonSortColor.method_25355((class_2561)new class_2585(arrow + " " + arrow + " " + I18nUtils.getString("minimap.waypoints.sortbycolor", new Object[0])));
     } else {
   ...
   private void deleteClicked() {
     ...
     if (var2 != null) {
       ...
       class_410 confirmScreen = new class_410(this, (class_2561)title, (class_2561)explanation, (class_2561)affirm, (class_2561)deny);
   ...
   private void teleportClicked() {
     ...
     int y = (this.selectedWaypoint.getY() > (class_310.method_1551()).field_1687.method_31607()) ? this.selectedWaypoint.getY() : (!this.options.game.field_1724.field_6002.method_8597().method_27998() ? (class_310.method_1551()).field_1687.method_31600() : 64);
