 ...
 public class GuiMinimapPerformance extends GuiScreenMinimap {
   ...
   public void method_25426() {
     ...
     for (EnumOptionsMinimap option : relevantOptions) {
       ...
       GuiOptionButtonMinimap optionButton = new GuiOptionButtonMinimap(leftBorder + var2 % 2 * 160, getHeight() / 6 + 24 * (var2 >> 1), option, (class_2561)class_2561.method_43470(text), this::optionClicked);
     ...
     this.worldSeedButton = new GuiButtonText(getFontRenderer(), leftBorder + var2 % 2 * 160, getHeight() / 6 + 24 * (var2 >> 1), 150, 20, (class_2561)class_2561.method_43470(buttonText), button -> this.worldSeedButton.setEditing(true));
     ...
     var2++;
     method_37063((class_364)new class_4185(getWidth() / 2 - 100, getHeight() / 6 + 168, 200, 20, (class_2561)class_2561.method_43471("gui.done"), button -> getMinecraft().method_1507(this.parentScreen)));
   }
   ...
   protected void optionClicked(class_4185 par1GuiButton) {
     ...
     par1GuiButton.method_25355((class_2561)class_2561.method_43470(perfBomb + perfBomb));
   }
   ...
   private void newSeed() {
     ...
     String buttonText = I18nUtils.getString("options.minimap.worldseed", new Object[0]) + ": " + I18nUtils.getString("options.minimap.worldseed", new Object[0]);
     this.worldSeedButton.method_25355((class_2561)class_2561.method_43470(buttonText));
     this.worldSeedButton.setText(this.master.getWorldSeed());
