  ...
  public void method_25394(class_4587 matrixStack, int mouseX, int mouseY, float partialTicks) {
    ...
    for (int keyCounter = 0; keyCounter < this.options.keyBindings.length; keyCounter++) {
      ...
      if (this.buttonId == this.options.keyBindings[keyCounter]) {
        ((class_4185)getButtonList().get(keyCounter)).method_25355((class_2561)class_2561.method_43470("> ").method_10852((class_2561)class_2561.method_43470("???").method_27661().method_27692(class_124.field_1054)).method_27693(" <").method_27692(class_124.field_1054));
