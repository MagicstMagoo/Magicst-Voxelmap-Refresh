 ...
 public class GuiAddWaypoint extends GuiScreenMinimap implements IPopupGuiScreen {
   ...
   protected DimensionContainer selectedDimension = null; private final IGuiWaypoints parentGui; private PopupGuiButton doneButton; private GuiSlotDimensions dimensionList;
   ...
   public void method_25426() {
     ...
     method_37063((class_364)(this.buttonEnabled = new PopupGuiButton(getWidth() / 2 - 101, buttonListY, 100, 20, (class_2561)new class_2585("Enabled: " + (this.waypoint.enabled ? "On" : "Off")), button -> this.waypoint.enabled = !this.waypoint.enabled, this)));
     method_37063((class_364)new PopupGuiButton(getWidth() / 2 - 101, buttonListY + 24, 100, 20, (class_2561)new class_2585(I18nUtils.getString("minimap.waypoints.sortbycolor", new Object[0]) + ":     "), button -> this.choosingColor = true, this));
     method_37063((class_364)new PopupGuiButton(getWidth() / 2 - 101, buttonListY + 48, 100, 20, (class_2561)new class_2585(I18nUtils.getString("minimap.waypoints.sortbyicon", new Object[0]) + ":     "), button -> this.choosingIcon = true, this));
     this.doneButton = new PopupGuiButton(getWidth() / 2 - 155, getHeight() / 6 + 168, 150, 20, (class_2561)new class_2588("addServer.add"), button -> acceptWaypoint(), this);
     method_37063((class_364)this.doneButton);
     method_37063((class_364)new PopupGuiButton(getWidth() / 2 + 5, getHeight() / 6 + 168, 150, 20, (class_2561)new class_2588("gui.cancel"), button -> cancelWaypoint(), this));
   ...
   public void method_25394(class_4587 matrixStack, int mouseX, int mouseY, float partialTicks) {
     ...
     float scScale = (float)getMinecraft().method_22683().method_4495();
     this.tooltip = null;
     this.buttonEnabled.method_25355((class_2561)new class_2585(I18nUtils.getString("minimap.waypoints.enabled", new Object[0]) + " " + I18nUtils.getString("minimap.waypoints.enabled", new Object[0])));
     ...
     if (this.choosingIcon) {
       ...
       if (mouseX >= getWidth() / 2 - displayWidth / 2 && mouseX <= getWidth() / 2 + displayWidth / 2 && mouseY >= getHeight() / 2 - displayHeight / 2 && mouseY <= getHeight() / 2 + displayHeight / 2) {
         ...
         if (icon != chooser.getMissingImage()) {
           this.tooltip = (class_2561)new class_2585(icon.getIconName().replace("voxelmap:images/waypoints/waypoint", "").replace(".png", ""));
         }
       } 
