 ...
 public class GuiSelectPlayer extends GuiScreenMinimap implements BooleanConsumer {
   protected class_2561 screenTitle = (class_2561)new class_2585("players"); private final class_437 parentScreen;
   ...
   final class_5250 SHARE_MESSAGE = (new class_2588("minimap.waypointshare.sharemessage")).method_27693(":");
   final class_2588 SHARE_WITH = new class_2588("minimap.waypointshare.sharewith");
   final class_2588 SHARE_WAYPOINT = new class_2588("minimap.waypointshare.title");
   final class_2588 SHARE_COORDINATES = new class_2588("minimap.waypointshare.titlecoordinate");
   ...
   public void method_25426() {
     this.screenTitle = this.sharingWaypoint ? (class_2561)this.SHARE_WAYPOINT : (class_2561)this.SHARE_COORDINATES;
     ...
     method_37063((class_364)new class_4185(this.field_22789 / 2 - 100, this.field_22790 - 27, 150, 20, (class_2561)new class_2588("gui.cancel"), button -> getMinecraft().method_1507(this.parentScreen)));
   ...
   protected void sendMessageToPlayer(String name) {
     ...
     if (combined.length() > 100) {
       (getMinecraft()).field_1724.method_3142("/msg " + name + " " + this.message.method_1882());
       (getMinecraft()).field_1724.method_3142("/msg " + name + " " + this.locInfo);
     } else {
       (getMinecraft()).field_1724.method_3142(combined);
     } 
   ...
   public void method_25394(class_4587 matrixStack, int mouseX, int mouseY, float partialTicks) {
     ...
     method_27534(matrixStack, getFontRenderer(), (class_2561)this.SHARE_WITH, getWidth() / 2, 75, 16777215);
