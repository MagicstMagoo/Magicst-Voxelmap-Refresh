 ...
 public class GuiMinimapOptions extends GuiScreenMinimap {
   ...
   public void method_25426() {
     ...
     class_4185 radarOptionsButton = new class_4185(getWidth() / 2 - 155, getHeight() / 6 + 120 - 6, 150, 20, (class_2561)new class_2588("options.minimap.radar"), button -> getMinecraft().method_1507((class_437)new GuiRadarOptions((class_437)this, this.master)));
     ...
     method_37063((class_364)new class_4185(getWidth() / 2 + 5, getHeight() / 6 + 120 - 6, 150, 20, (class_2561)new class_2588("options.minimap.detailsperformance"), button -> getMinecraft().method_1507((class_437)new GuiMinimapPerformance((class_437)this, this.master))));
     method_37063((class_364)new class_4185(getWidth() / 2 - 155, getHeight() / 6 + 144 - 6, 150, 20, (class_2561)new class_2588("options.controls"), button -> getMinecraft().method_1507((class_437)new GuiMinimapControls((class_437)this, this.master))));
     method_37063((class_364)new class_4185(getWidth() / 2 + 5, getHeight() / 6 + 144 - 6, 150, 20, (class_2561)new class_2588("options.minimap.worldmap"), button -> getMinecraft().method_1507((class_437)new GuiPersistentMapOptions((class_437)this, this.master))));
