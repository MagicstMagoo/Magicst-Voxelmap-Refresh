 ...
 class GuiSlotMobs
   ...
   final class_2561 ENABLE = (class_2561)class_2561.method_43471("options.minimap.mobs.enable");
   final class_2561 DISABLE = (class_2561)class_2561.method_43471("options.minimap.mobs.disable");
   final class_2561 ENABLED = (class_2561)class_2561.method_43471("options.minimap.mobs.enabled");
   final class_2561 DISABLED = (class_2561)class_2561.method_43471("options.minimap.mobs.disabled");
   ...
   public void setSelected(MobItem item) {
     ...
     if (method_25334() instanceof MobItem) {
       class_333.field_2054.method_19788(class_2561.method_43469("narrator.select", new Object[] { ((MobItem)method_25334()).name }).getString());
     }
