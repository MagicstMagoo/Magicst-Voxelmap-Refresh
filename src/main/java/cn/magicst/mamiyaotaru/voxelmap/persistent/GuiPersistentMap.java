...
public class GuiPersistentMap extends PopupGuiScreen implements IGuiWaypoints {
   private Random generator = new Random(); private class_310 mc;
  ...
  public void method_25426() {
     ...
     method_37063((class_364)new PopupGuiButton(this.sideMargin + 0 * (this.buttonWidth + this.buttonSeparation), getHeight() - 28, this.buttonWidth, 20, (class_2561)new class_2588("options.minimap.waypoints"), buttonWidget_1 -> getMinecraft().method_1507((class_437)new GuiWaypoints((class_437)this, this.master)), (IPopupGuiScreen)this));
     ...
     if (!getMinecraft().method_1496() && !this.master.getWaypointManager().receivedAutoSubworldName()) {
       method_37063((class_364)(this.buttonMultiworld = new PopupGuiButton(this.sideMargin + 1 * (this.buttonWidth + this.buttonSeparation), getHeight() - 28, this.buttonWidth, 20, (class_2561)this.multiworldButtonName, buttonWidget_1 -> getMinecraft().method_1507((class_437)new GuiSubworldsSelect((class_437)this, this.master)), (IPopupGuiScreen)this)));
    }
    
     method_37063((class_364)new PopupGuiButton(this.sideMargin + 3 * (this.buttonWidth + this.buttonSeparation), getHeight() - 28, this.buttonWidth, 20, (class_2561)new class_2588("menu.options"), null, (IPopupGuiScreen)this) {
     ...
     method_37063((class_364)new PopupGuiButton(this.sideMargin + 4 * (this.buttonWidth + this.buttonSeparation), getHeight() - 28, this.buttonWidth, 20, (class_2561)new class_2588("gui.done"), null, (IPopupGuiScreen)this) {
          public void method_25306() {
     ...
     if (this.buttonMultiworld != null) {
       if ((this.subworldName == null || this.subworldName.equals("")) && this.master.getWaypointManager().isMultiworld()) {
         if ((int)(System.currentTimeMillis() / 1000L % 2L) == 0) {
           ...
           this.buttonMultiworld.method_25355((class_2561)this.multiworldButtonName);
        } 
      } else {
         this.buttonMultiworld.method_25355((class_2561)this.multiworldButtonName);
      } 
  ...
  public void popupAction(Popup popup, int action) {
    ...
    TreeSet<DimensionContainer> dimensions;
     ...
     double dimensionScale = this.mc.field_1724.field_6002.method_8597().method_31110();
     switch (action) {
      case 0:
         if (hovered != null) {
           x = hovered.getX();
      ...
      case 3:
         if (hovered != null) {
           ...
           y = (this.selectedWaypoint.getY() > (class_310.method_1551()).field_1687.method_31607()) ? this.selectedWaypoint.getY() : (!this.mc.field_1724.field_6002.method_8597().method_27998() ? (class_310.method_1551()).field_1687.method_31600() : 64);
           ...
           if (y == 0) {
             y = !this.mc.field_1724.field_6002.method_8597().method_27998() ? (class_310.method_1551()).field_1687.method_31600() : 64;
          }
